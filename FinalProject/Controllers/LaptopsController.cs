...
namespace FinalProject.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,Hang,Gia,ManHinh,Os,Webcam,NhuCau,Chip,Vga,Ram,Rom,Pin,KhoiLuong,CongGiaoTiep,ThietKe,ImagePath")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
