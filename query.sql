...
', N'Intel Iris Xe graphics', 16, 512, N'36Wh', 0.99, N'1x USB 3.2 Gen1 (Type-A);1x USB 3.2 Gen2 (Type-A);1x Thunderbolt™ 4 (Type-C) (USB4 / DP / PD charging);1x HDMI 2.0 (with HDCP);1x Audio combo jack;1x MicroSD Card Reader;1x DC-in Jack', N'hợp kim nhôm magie', N'https://product.hstatic.net/1000026716/product/gearvn-laptop-gigabyte-u4-ud-50s1823so-2_59106787f3654ef499585f2ab36008ba.png'),
 ...
 (22, N'U4 UD 70S1823SO', N'GIGABYTE', CAST(25390000.00 AS Decimal(18, 2)), N'14.0" FHD (1920x1080) Thin Bezel, IPS-level, Anti-glare Display LCD,~100% sRGB', N'Windows 11 Home', N'HD Camera', N' Văn phòng', N'Intel Core i7-1195G7 (4 lõi, 8 luồng, tối đa 5,0 GHz)', N'Intel Iris Xe graphics', 16, 512, N'36Wh', 0.99, N'1x USB 3.2 Gen1 (Type-A);1x USB 3.2 Gen2 (Type-A);1x Thunderbolt™ 4 (Type-C) (USB4 / DP / PD charging);1x HDMI 2.0 (with HDCP);1x Audio combo jack;1x MicroSD Card Reader;1x DC-in Jack', N'hợp kim nhôm magie', N'https://product.hstatic.net/1000026716/product/gearvn-laptop-gigabyte-u4-ud-70s1823so-4_48c2c6269a504b628ae6d7d3c1e88fb9.png'),

 (23, N'G15 5511 70266676', N'DELL', CAST(19990001.00 AS Decimal(18, 2)), N'15.6" FHD (1920 x1080) 120Hz, 250 nits, WVA, Anti-Glare, LED Backlit, Narrow Border Display', N'Windows 11 Home', N'RGB HD camera (720p) ', N'Gaming, Văn phòng, Đồ họa - Kỹ thuật', N'Intel Core i5-11400H 2.7GHz up to 4.5GHz 12MB', N'NVIDIA GeForce RTX 3050 4GB GDDR6', 8, 256, N'3 Cell 56WHr', 2.65, N'1x USB 3.2 Gen 2 Type-C port with Display Port;3x USB 3.2 Gen 1;1x HDMI 2.1;1x RJ45
